...
/**
 * Numbers shared throughout replicatorg.core.
 * <P>
...
public interface PConstants {
  ...
  // renderers known to replicatorg.core

  static final String P2D    = "replicatorg.core.PGraphics2D";
  static final String P3D    = "replicatorg.core.PGraphics3D";
  static final String JAVA2D = "replicatorg.core.PGraphicsJava2D";
  static final String OPENGL = "replicatorg.opengl.PGraphicsOpenGL";
  static final String PDF    = "replicatorg.pdf.PGraphicsPDF";
  static final String DXF    = "replicatorg.dxf.RawDXF";
  //static final String SVG    = "replicatorg.dxf.PGraphicsSVG";
  ...
  // @see replicatorg.core.PImage#blendColor(int,int,int)
