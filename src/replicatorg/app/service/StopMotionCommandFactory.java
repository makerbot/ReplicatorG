...
public class StopMotionCommandFactory extends RemoteCommandFactory
{
        ...
        throws MissingArgumentException, ExtraArgumentsException
    {
        ...
        {
            throw new ExtraArgumentsException("stopMotion", buildArguments);
        }
        else
        {
            final String busName = handleBusName(commandLine);
            final Command command = new StopMotionCommand(busName);
            return command;
        }
    }
}
