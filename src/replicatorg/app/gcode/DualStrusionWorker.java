...
public class DualStrusionWorker extends SwingWorker<MutableGCodeSource, Integer>{

	final JPanel panel;
	final JProgressBar dualstrusionProgress;
	DualStrusionConstruction dsConstruction;
	
	public DualStrusionWorker(JPanel panel)
	{
		this.panel = panel;
		dualstrusionProgress = new JProgressBar();
		
		panel.setLayout(new MigLayout("fill"));
		
	}
	
	public void setConstruction(DualStrusionConstruction dsc)
	{
		dsConstruction = dsc;
	}
	...
	@Override
	protected MutableGCodeSource doInBackground() throws Exception
	{
		dsConstruction.combine();
		
		/*
		 * if dsc produced events, we could catch them here and call publish() on them
		 */

		return dsConstruction.getCombinedFile();
	}
