...
class XMLElement:
	...
	def addToIdentifierDictionaryIFIdentifierExists(self):
		...
		if 'name' in self.attributeDictionary:
			...
			euclidean.addElementToListTableIfNotThere(self, nameKey, self.getRoot().nameDictionary)
		for tagKey in self.getTagKeys():
			euclidean.addElementToListTableIfNotThere(self, tagKey, self.getRoot().tagDictionary)
